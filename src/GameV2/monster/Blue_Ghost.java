 ...
 * מחלקת הרוח הכחולה
 * מאפיינים:
 * - תנועה אקראית על המפה
 * - מהירות תנועה בינונית
 * - בדיקת התנגשויות עם קירות
 */
public class Blue_Ghost extends JPanel implements Runnable {
    // תמונת הרוח
    ...
    public void loadImage() {
        try {
            image = ImageIO.read(new File("C:/Users/JBH/IdeaProjects/zevi/src/GameV2/img/BlueGhost.png"));
        } catch (IOException e) {
     ...
     * רץ ברקע ומזיז את הרוח כל 200 מילישניות
     */
    @Override
    public void run() {
        while (isMoving) {
